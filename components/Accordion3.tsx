...
const Accordion3: React.FC<AccordionProps> = ({question, answer, turn, setTurn, idx}) => {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-full px-2 text-lg pt-4 lg:text-base border-2 rounded-xl border-blue-500 my-5'>
        <div className='py-3 w-full'>
           ...
           <div ref={contentRef} className='mx-4 overflow-hidden text-left transition-all duration-500 h-full'>
                ...
                <div className='flex justify-center my-5'>
                  ...
                  }} variant="contained" style={{backgroundColor: 'blue'}}>Save</Button>
                </div>
           </div>
        </div>
    </div>
